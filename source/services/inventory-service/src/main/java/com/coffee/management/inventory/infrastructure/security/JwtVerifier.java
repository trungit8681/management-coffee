package com.coffee.management.inventory.infrastructure.security;

import com.coffee.management.inventory.application.Actor;
...
public class JwtVerifier {
    ...
    @Autowired
    public JwtVerifier(@Value("${inventory.jwt.issuer}") String issuer,
            @Value("${inventory.jwt.audience}") String audience,
            @Value("${inventory.jwt.jwks-uri}") String jwksUri,
            @Value("${inventory.jwt.jwks-cache-ttl:PT5M}") Duration cacheTtl) {
