...
import com.coffee.management.organization.application.Actor;
...
public class JwtVerifier {
    ...
    @Autowired
    public JwtVerifier(@Value("${organization.jwt.issuer}") String issuer,
            @Value("${organization.jwt.audience}") String audience,
            @Value("${organization.jwt.jwks-uri}") String jwksUri,
            @Value("${organization.jwt.jwks-cache-ttl:PT5M}") Duration cacheTtl) {
