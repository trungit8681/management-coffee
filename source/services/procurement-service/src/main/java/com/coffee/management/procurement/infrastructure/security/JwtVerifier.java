...
import com.coffee.management.procurement.application.Actor;
...
public class JwtVerifier {
    ...
    @Autowired
    public JwtVerifier(@Value("${procurement.jwt.issuer}") String issuer,
            @Value("${procurement.jwt.audience}") String audience,
            @Value("${procurement.jwt.jwks-uri}") String jwksUri,
            @Value("${procurement.jwt.jwks-cache-ttl:PT5M}") Duration cacheTtl) {
